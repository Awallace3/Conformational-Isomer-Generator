...
def make_conf_input_dir(num_u_confs):
...
def sdf_dict_cart(sdf_dict, num_atoms, element_dict, conf_num=conf_num):
    bond_length = {}
    cnt = 1
    ...
    clean_carts(num_u_confs)
    #make_conf_input_dir(num_u_confs)

    
    return print(num_u_confs)
